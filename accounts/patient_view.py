...
def patientHome(request):
    patient_obj = Patient.objects.get(admin=request.user.id)
...
def patientProfile(request):
    ...
    patien = Patient.objects.get(admin=customuser.id)
...
def patient_feedback(request):
    patient_fed = Patient.objects.get(admin=request.user.id)
...
def patient_feedback_save(request):
    if request.method == "POST":
        ...
        staff_obj = Patient.objects.get(admin=request.user.id)
